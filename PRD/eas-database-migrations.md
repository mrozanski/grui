...
**Purpose:** This document contains all SQL-level database changes required for EAS (Ethereum Attestation Service) implementation in the String Authority.
...
This migration adds support for blockchain attestations to String Authority:
...
5. **Constraints:** Any additional constraints or validations needed at the database level?
